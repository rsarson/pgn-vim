...
syntax match pgnFEN /\([PNBRQKpnbrqk1-8]\+\)\(\/[PNBRQKpnbrqk1-8]\+\)\{7\} \(w\|b\) \(\-\|K\?Q\?k\?q\?\) \(\-\|[a-h][36]\) \(0\?[0-9]\+\) \([1-9][0-9]*\)/ containedin=pgnTagValue,pgnCommentBlock,pgnCommentSingleLine contained
